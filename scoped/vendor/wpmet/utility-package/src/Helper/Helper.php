...
namespace UltimateYoutubeFeedScoped\Wpmet\UtilityPackage\Helper;
...
class Helper
{
    public static function kses($raw)
    {
        ...
        if (\function_exists('UltimateYoutubeFeedScoped\\wp_kses')) {
            // WP is here
    ...
    {
        return \UltimateYoutubeFeedScoped\Composer\InstalledVersions::getPrettyVersion('wpmet/utility-package');
    }
}
