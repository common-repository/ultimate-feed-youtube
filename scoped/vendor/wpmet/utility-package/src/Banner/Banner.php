...
namespace UltimateYoutubeFeedScoped\Wpmet\UtilityPackage\Banner;

\defined('ABSPATH') || exit;
use UltimateYoutubeFeedScoped\Wpmet\UtilityPackage\Helper\Helper as UtilsHelper;
/**
 * Showing Banners
 * other stuffs
 * Class Banner
    ...
    public function display_content()
    {
        ...
        foreach ($this->data as $content) {
            ...
            if ($content->start <= \time() && \time() <= $content->end) {
                ...
                if ($this->is_correct_screen_to_show($content->screen, $screen->id) && \class_exists('UltimateYoutubeFeedScoped\\Wpmet\\UtilityPackage\\Notice\\Notice')) {
                    $inline_css = '';
                    ...
                    $instance = \UltimateYoutubeFeedScoped\Wpmet\UtilityPackage\Notice\Notice::instance('wpmet-jhanda', $banner_unique_id)->set_dismiss('global', 3600 * 24 * 15);
