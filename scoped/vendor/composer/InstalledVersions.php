 ...
 */
namespace UltimateYoutubeFeedScoped\Composer;

use UltimateYoutubeFeedScoped\Composer\Autoload\ClassLoader;
use UltimateYoutubeFeedScoped\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('UltimateYoutubeFeedScoped\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
